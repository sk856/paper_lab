...
PUBLIC_DEFAULT_API_CONFIG = {
    ...
    'website': '',
    'remark': '公共默认接口，额度受限',
    'base_url': os.environ.get('THESIS_WORKSHOP_PUBLIC_BASE_URL', ''),
    'key': os.environ.get('THESIS_WORKSHOP_PUBLIC_API_KEY', ''),
    'model': os.environ.get('THESIS_WORKSHOP_PUBLIC_MODEL', ''),
    'model_display_name': os.environ.get('THESIS_WORKSHOP_PUBLIC_MODEL_DISPLAY', ''),
