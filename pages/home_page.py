...
class HomePage:
    ...
    def _build_hero(self):
        ...
        self.hero_canvas.pack(fill=tk.X, expand=True)
    ...
    def _show_model_list(self):
        ...
        def _show_test_toast(message, ok):
            ...
            toast.configure(bg=COLORS['bg_main'])
            try:
            ...
            shell = tk.Frame(toast, bg=COLORS['bg_main'])
            shell.pack()
            card = tk.Frame(
                shell,
                bg=COLORS['card_bg'],
        ...
        def _create_action_icon(parent, *, icon, tooltip, fg, command, active_bg, active_fg=None, image_name=None):
            shell = tk.Frame(
                parent,
                bg=parent.cget('bg') if 'bg' in parent.keys() else COLORS['bg_main'],
